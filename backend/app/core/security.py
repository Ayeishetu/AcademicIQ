...
def hash_password(password: str) -> str:
    # bcrypt has a 72-byte limit; newer versions raise instead of silently truncating.
    # Pre-truncate to maintain consistent behaviour across all bcrypt versions.
